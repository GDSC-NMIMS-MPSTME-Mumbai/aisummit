                ...
                <div className="row">
                    <div className="col-sm-12">
                        <div className="about">
                            ...
                            <li><a href="https://www.linkedin.com/company/google-developer-student-club-mpstme/" title="" target="__blank"><i className ="fa fa-linkedin"/></a></li>
                            <li><a href="https://www.instagram.com/gdsc.mpstme/" title="" target="__blank"><i className ="fa fa-instagram"/></a></li>
                            <li><a href="https://github.com/GDSC-NMIMS-MPSTME-Mumbai" title="" target="__blank"><i className ="fa fa-github"/></a></li>
                            <li><a href="https://gdsc.community.dev/mukesh-patel-school-of-technology-management-and-engineering-mumbai/" title="" target="__blank"><i className ="fa fa-google"/></a></li>
                            </ul> }
                            </div>
                        </div>
                    </div>
